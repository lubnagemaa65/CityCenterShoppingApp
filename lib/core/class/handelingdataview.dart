...
import 'package:work_os/core/constant/imageAssey.dart';

class HandelingDataView extends StatelessWidget{
  final StatusRequest ?statusRequest;
  final Widget widget;
  const HandelingDataView({Key? key, required this.statusRequest, required this.widget}) : super(key: key);
...
class HandelingDataRequest extends StatelessWidget{
  final StatusRequest ?statusRequest;
  final Widget widget;
  const HandelingDataRequest({Key? key, required this.statusRequest, required this.widget}) : super(key: key);
